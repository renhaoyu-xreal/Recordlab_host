...
`agents_config_path/nodes_root/product_config_path/echo_python_root/data_root/logs_root/python_bin/node_runtime_module/data_registry_host/data_registry_port`。
环境变量 `RECORDLAB_AGENTS_CONFIG`、`RECORDLAB_NODES_ROOT`、
`RECORDLAB_PRODUCT_CONFIG`、`ECHO_MESSAGE_SYSTEM_PYTHON_ROOT`、`RECORDLAB_DATA_ROOT`、
